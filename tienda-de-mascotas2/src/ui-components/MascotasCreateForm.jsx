...
export default function MascotasCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAcerca(initialValues.Acerca);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Mascotas(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MascotasCreateForm")}
      {...rest}
    >
      <TextField
        label="Nombre"
